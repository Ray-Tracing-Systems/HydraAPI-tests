...
\boldblue{Test:} test78\_material\_remap\_list1. PSNR should be greater than 35 for 512x512 LDR image.
...
\boldblue{(!) Implementation REQ. :} Note that final color of the image should be first clamped and then transformed from HDR to LDR space with gamma correction according to \cite{srgb}.
...
\boldblue{REQ:} PSNR should be greater or equal 35 for 512x512 LDR image.
	...
	\begin{table}[htbp]
		...
		\begin{tabular}{cc}
			...
			\includegraphics[width=0.4\textwidth]{../../../comparisonrender/Report/Images/Lambert/Lambert_cornell_mitsuba.png} \\
			\hline
...
\boldblue{Test:} 123\_emission. PSNR should be greater than 35 for 512x512 LDR image. 
...
\boldblue{Test:} test\_103\_diffuse\_texture. PSNR should be greater than 35 for 512x512 LDR image.
\begin{figure}[htb]
	\centering
...
\boldblue{Test:} test\_124\_emission\_texture. PSNR should be greater than 35 for 512x512 LDR image.
\begin{figure}[htb]
	\centering

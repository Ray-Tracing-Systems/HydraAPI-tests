...
\newpage
\reqirenmentlight{alg\_paths}

Further path grammar must occur in scenes:
\begin{enumerate}
\item ESDL and EDSL --- single mirror in scene that is also reflect single reflected caustic;	
\item ESDSL (R) --- single reflected caustic, that is visible in the mirror; 
\item ESDSL (T) --- single refracted caustic to check light transport symmetry;
\item E*SS*L --- double perfect reflection.	
\item E*GG*L --- double glossy reflection.	
\end{enumerate}	


Suggested scenes:
\begin{enumerate}
\item one mirror wall in diffuse Cornell box (ESDL,EDSL, ESDSL (R));	
\item one glossy wall in diffuse Cornell box (EGDL,EDGL, EGDGL (R));	
\item one mirror wall and mirror teapot in Cornell box;
\item one mirror wall and glossy teapot in Cornell box.
\item one glossy wall and glossy teapot in Cornell box (fig. \ref{fig:rotatedlights}, left).
\item two mirror walls and mirror teapot in Cornell box;
\item two mirror walls and glossy teapot in Cornell box;
\item two glossy walls and mirror teapot in Cornell box;
\item two glossy walls and glossy teapot in Cornell box.
\end{enumerate}
